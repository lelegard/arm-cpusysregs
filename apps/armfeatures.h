...
public:
    ...
    bool FEAT_Armv9_Crypto() const { return FEAT_SVE_AES(); } // From Arch Manual
    ...
    bool FEAT_Crypto() const { return FEAT_AES() || FEAT_SHA1() || FEAT_SHA3() || FEAT_SHA512() || FEAT_SM3() || FEAT_SM4(); } // From Arch Manual
