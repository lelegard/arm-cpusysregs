...
public:
    ...
    int ID_AA64FPFR0_EL1_F8E4M3() const { return (int)(_aa64fpfr0 >> 7) & 0x01; }
    ...
    int ID_AA64SMFR0_EL1_SF8DP2() const { return (int)(_aa64smfr0 >> 18) & 0x01; }
    ...
    int PMSIDR_SME() const { return (int)(_pmsidr >> 32) & 0x01; }
    int PMSIDR_ALTCLK() const { return (int)(_pmsidr >> 28) & 0x0F; }
    int PMSIDR_FPF() const { return (int)(_pmsidr >> 27) & 0x01; }
    int PMSIDR_EFT() const { return (int)(_pmsidr >> 26) & 0x01; }
    ...
    // Implemented level: Armv9.4-A (ref manual rev K.a)
    ...
    bool FEAT_SPE_ALTCLK() const { return PMSIDR_ALTCLK() >= 1; }
    bool FEAT_SPE_CRR() const { return PMSIDR_CRR() >= 1; }
    bool FEAT_SPE_DPFZS() const { return ID_AA64DFR1_EL1_DPFZS() == 1; }
    bool FEAT_SPE_EFT() const { return PMSIDR_EFT() == 1; }
    bool FEAT_SPE_FDS() const { return PMSIDR_FDS() >= 1; }
    bool FEAT_SPE_FPF() const { return PMSIDR_FPF() == 1; }
    bool FEAT_SPE_SME() const { return PMSIDR_SME() == 1; }
...
private:
    bool      _loaded = false;
    csr_u64_t _aa64isar0 = 0;
    csr_u64_t _aa64isar1 = 0;
    csr_u64_t _aa64isar2 = 0;
    csr_u64_t _aa64isar3 = 0;
    csr_u64_t _aa64pfr0 = 0;
    csr_u64_t _aa64pfr1 = 0;
    csr_u64_t _aa64pfr2 = 0;
    csr_u64_t _aa64dfr0 = 0;
    csr_u64_t _aa64dfr1 = 0;
    csr_u64_t _aa64dfr2 = 0;
    csr_u64_t _aa64fpfr0 = 0;
    csr_u64_t _aa64mmfr0 = 0;
    csr_u64_t _aa64mmfr1 = 0;
    csr_u64_t _aa64mmfr2 = 0;
    csr_u64_t _aa64mmfr3 = 0;
    csr_u64_t _aa64mmfr4 = 0;
    csr_u64_t _aa64smfr0 = 0;
    csr_u64_t _aa64zfr0 = 0;
    csr_u64_t _isar0 = 0;
    csr_u64_t _isar1 = 0;
    csr_u64_t _isar2 = 0;
    csr_u64_t _isar3 = 0;
