...
| ------------------------ | -------- | --------- | :-----: | -----------------------
| FEAT_AArch32             |          |           |  X  | AArch32 is supported
| FEAT_AA32BF16            | Armv8.2  |           |  X  | AArch32 BFloat16 instructions
| FEAT_AA32HPD             | Armv8.2  |           |  X  | AArch32 Hierarchical permission disables
| FEAT_AA32I8MM            | Armv8.2  |           |  X  | AArch32 Int8 Matrix Multiplication
| FEAT_ABLE                |          |           |  X  | Address Breakpoint Linking extension
| FEAT_ADERR               |          |           |  X  | RASv2 Additional Error syndrome reporting, for Device memory
| FEAT_AdvSIMD             |          |           |  X  | Advanced SIMD Extension
...
| FEAT_ASMv8p2             |          | Armv8.2   | n/a | BDC and REV64 alias instructions
| FEAT_B16B16              |          |           |  X  | Non-widening BFloat16 to BFloat16 arithmetic for SVE2.1 and SME2.1
...
| FEAT_EBEP                |          |           |  X  | Exception-based event profiling
...
| FEAT_FGT2                |          |           |  X  | Fine Grain Traps 2
...
| FEAT_ITE                 |          |           |  X  | Instrumentation trace extension
...
| FEAT_LRCPC3              |          |           |  X  | Load-Acquire RCpc instructions version 3
...
| FEAT_MPAMv0p1            |          |           |  X  | Memory Partitioning and Monitoring version 0.1
| FEAT_MPAMv1p0            |          |           |  X  | Memory Partitioning and Monitoring version 1.0
| FEAT_MPAMv1p1            |          |           |  X  | Memory Partitioning and Monitoring version 1.1
...
| FEAT_MTE_CANONICAL_TAGS  |          |           |  X  | Support for Canonical tag checking
| FEAT_MTE_NO_ADDRESS_TAGS |          |           |  X  | Support for Memory tagging with Address tagging disabled
| FEAT_MTE_PERM            |          |           |  X  | Allocation tag access permission
| FEAT_MTE_STORE_ONLY      |          |           |  X  | Support for Store-only Tag checking
| FEAT_MTE_TAGGED_FAR      |          |           |  X  | Support for reporting of all non-address bits on a fault
...
| FEAT_PMUv3p9             |          |           |  X  | EL0 access controls for PMU event counters
| FEAT_PMUv3_EDGE          |          |           |  X  | PMU event edge detection
| FEAT_PMUv3_EXT32         |          |           | n/a | Original mostly 32-bit external interface to the Performance Monitors
| FEAT_PMUv3_EXT64         |          |           | n/a | Optional 64-bit external interface to the Performance Monitors
| FEAT_PMUv3_ICNTR         |          |           |  X  | PMU instruction counter
| FEAT_PMUv3_SS            |          |           |  X  | PMU snapshot
...
| FEAT_RASv2               |          |           |  X  | Reliability, Availability, and Serviceability (RAS) Extension version 2
...
| FEAT_SEBEP               |          |           |  X  | Synchronous Exception-based event profiling
...
| FEAT_SME2                |          |           |  X  | Scalable Matrix Extension versions SME2
| FEAT_SME2p1              |          |           |  X  | Scalable Matrix Extension versions SME2.1
| FEAT_SME_F16F16          |          |           |  X  | Non-widening half-precision FP16 to FP16 arithmetic for SME2.1
...
| FEAT_SPECRES2            |          |           |  X  | Adds new Clear Other Speculative Predictions instruction
| FEAT_SPE_CRR             |          |           |  X  | SPE with Call Return information
| FEAT_SPE_FDS             |          |           |  X  | SPE filtering by data source
...
| FEAT_SPEv1p4             |          |           |  X  | Addtional SPE events
| FEAT_SPMU                |          |           |  X  | System PMU
...
| FEAT_SVE2p1              |          |           |  X  | Scalable Vector Extension version SVE2.1
...
| FEAT_TRBE_EXT            |          |           | n/a | Represents TRBE external mode
| FEAT_TRBE_MPAM           |          |           | n/a | Trace Buffer MPAM extensions
