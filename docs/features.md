...
| FEAT_AA64EL0             | Armv8.0  |           |  X  | Support for AArch64 at EL0
| FEAT_AA64EL1             | Armv8.0  |           |  X  | Support for AArch64 at EL1
...
| FEAT_BWE2                |          |           |  X  | Breakpoints and watchpoint enhancements 2
...
| FEAT_CPA                 |          |           |  X  | Checked Pointer Arithmetic instructions
| FEAT_CPA2                |          |           |  X  | CPA instructions can be enabled
| FEAT_CRC32               | Armv8.0  | Armv8.1   |  X  | CRC32 instructions
| FEAT_Crypto              |          |           |  X  | Cryptographic Extension
| FEAT_CSSC                | Armv8.7  |           |  X  | Common Short Sequence Compression scalar integer instructions
...
| FEAT_ETS2                | Armv8.0  | Armv8.8   |  X  | Enhanced Translation Synchronization 2
| FEAT_EVT2                | Armv8.2  | Armv8.5   |  X  | Enhanced Virtualization Traps
...
| FEAT_FAMINMAX            |          |           |  X  | Advanced SIMD, SVE2, and SME2 FAMIN and FAMAX instructions
...
| FEAT_FP8                 |          |           |  X  | FP8 convert instructions
| FEAT_FP8DOT2             |          |           |  X  | FP8 to half-precision 2-way dot product
| FEAT_FP8DOT4             |          |           |  X  | FP8 to single-precision 4-way dot product
| FEAT_FP8FMA              |          |           |  X  | FP8 multiply-accumulate instructions
...
| FEAT_LUT                 |          |           |  X  | Lookup table instructions with 2-bit and 4-bit indices
...
| FEAT_RASSAv1p1           |          |           | n/a | RAS System Architecture version 1.1
...
| FEAT_SEBEP               | Armv9.3  |           |  X  | Synchronous Exception-based event profiling
...
| FEAT_SME2                | Armv9.2  |           |  X  | Scalable Matrix Extension versions SME2
| FEAT_SME2p1              | Armv9.2  |           |  X  | Scalable Matrix Extension versions SME2.1
...
| FEAT_SPEv1p2             | Armv8.6  | Armv8.7   |  X  | Statistical Profiling Extensions version 1.2
...
| FEAT_STEP2               |          |           |  X  | Enhanced Software Step Extension
...
| FEAT_TLBIW               |          |           |  X  | TLBI VMALL for Dirty state
