...
// These definition were automatically generated using the script aarch/extract-arm-spec.py
//
...
#define _setreg2(id, sreg_high, sreg_low, features) \
    ...
    switch (regid) {
        ...
        _setreg(CSR_REGID_CNTPS_CTL_EL1, CSR_SREG_CNTPS_CTL_EL1, 0);
...
#define _getreg2(id, sreg_high, sreg_low, features) \
    ...
    switch (regid) {
        ...
        _getreg(CSR_REGID_CNTPS_CTL_EL1,    CSR_SREG_CNTPS_CTL_EL1, 0);
